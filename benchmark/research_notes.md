...
## GreenRush-8 — Cove at Silver Sky (Herriman S2023-113) — CONFIRMED BUILT, document-blocked

**Status: not_scored** — approved lot count + plat ROW + membership are document gaps, not research failures.

**Research completed 2026-09-24 by GreenRush-8:**

- **Official record:** Herriman PC agenda 2024-03-20 (https://www.utah.gov/pmn/files/1097511.pdf): Item 4.2, "preliminary subdivision plat known as Cove at Silver Sky, located approximately at 12754 S 6200 West in the R-1-10 Residential Single-Family Zone. Applicant: Scott Yermish (property owner). Acres: ±11.75. File No: S2023-113." Staff report link (Item 4.2, 3-20-24 S3 bucket) UNREACHABLE this turn — browser_open terminal, no retry permitted.
- **Herriman process finding:** Final plats are approved administratively by the Engineering Department — "No further Planning Commission or City Council meetings are required" (herriman.gov Preliminary Subdivision Plat Application). So no PC/Council final-approval record exists to find; the recorded plat is the only official approval artifact.
- **CONFIRMED BUILT:** 2025–2026 MLS new-construction listings name subdivision "COVE AT SILVER SKY": 6158 W Silver Sky Dr #102 ($1.676M), 12729 S Harlow Ann Way #101, 12763 S Harlow Ann Way #103, 12778 S Harlow Ann Way #105. Lot sizes 0.21–0.25 ac — consistent with R-1-10 (10,000 sqft min). Final plat was recorded ~2024.
- **UGRC child-fabric leg (executed, f=json outSR=102100):** 34 current parcels with Silver Sky Dr / Harlow Ann Way addresses (Herriman). Cluster areas: Harlow Ann Way block 263513010 (7 lots) = 1.71 ac; Silver Sky west block 26351260x/7x/9x (12 lots) = 3.64 ac; mid block 26342784x/6xx/8xx (8 lots) = 5.30 ac; scatter (7) ≈ 1 ac. **Total ≈ 11.65 ac vs official 11.75 ac (0.9% diff)** — suggestive but NOT proof of membership: parcel-ID blocks differ (likely multiple phases/recordings), open UGRC service has no SUBDIV_NAME field, ParcelNotes uninformative ("Supplied by county as latest"). Per the GR5 Swaner lesson (membership unprovable → no union built), NO parent GeoJSON was built to benchmark standard. Raw child geometry cached at /tmp/cove_children.json (ephemeral).
- **Binding gaps:** (1) APPROVED lot count — no official source (current 34 parcels ≠ approved count; some may be common areas); (2) plat ROW classification — Herriman RD-01B (60' ROW → 32 ft asphalt) vs RD-01C (53' ROW → 28 ft) unassigned without staff report/plat; (3) R-1-10 Tier-2 params (10,000 sqft / 80 ft via herriman.primegov.com attachment 898.pdf) still context-unconfirmed.
...
## GreenRush-13 — Daybreak Village 11B Plat 2 vote-gated attempt — NOT SCORED, product gate failed; pivot surveyed (2026-09-24)

**Mission:** third approved plat in the NERON benchmark lane, hard-gated: (1) confirm official approval vote, (2) confirm harness can score mixed detached/townhome product, (3) still-current parent within 5% before geometry. Claim: Daybreak Village 11B Plat 2 (South Jordan PLPP202500089), 91 lots (59 detached + 32 townhomes), 12.731 ac, P-C.

**GATE 1 (vote) — PASSED.**
- Official staff report re-verified HTTP 200 on 2026-09-24 (2.96 MB PDF): https://mccmeetingspublic.blob.core.usgovcloudapi.net/sojordanut-meet-65f12a7285274899b5527a663c59e92b/ITEM-Attachment-001-b1f37ab9350d46f68a5d4d03862ab3a0.pdf
- Report facts: "Generally located on the west side of Bingham Rim Road between 11800 S and Meadow Grass Drive"; "Acreage 12.731 Acres"; "Current Zone P-C (Planned Community)"; "91 residential lots (includes 59 single family detached and 32 townhomes), 5 park lots and associated public right-of-way"; gross density 7.1 u/ac, net 13.9 u/ac; applicant Perigee Consulting for LHM Real Estate; planner Greg Schindler.
- Official minutes re-verified HTTP 200 on 2026-09-24: https://www.sjc.utah.gov/DocumentCenter/View/8242/06-24-2025-Planning-Commission-Meeting-Minutes — Commissioner Bishop moved to approve PLPP202500089, Chair Gedge seconded, roll call 6-0 unanimous. Preliminary subdivision approval is OFFICIALLY CONFIRMED.
- Adversarial note: the staff-report ITEM attachment carries only the report + location map + plat figure; the adopted design-guidelines attachment (with dimensional minimums) lives in the full meeting packet (V11B P2 PACKET.pdf, 2.82 MB) and was NOT reached this wave. Dimensional inputs for V11B therefore remain underived — recorded honestly as zoning.status "unknown" in plats.json.

**GATE 2 (product) — FAILED; plat NOT scored.**
- Code inspection 2026-09-24: benchmark/harness.py passes ONE zoning dict to the pipeline and compares the COUNT of generated lot polygons to approved_lots; prototype/pipeline.py runs ONE geometry.plan_generation call per boundary with ONE zoning config (validated by _validate_zoning: min_lot_area_sqft / min_frontage_ft / road_width_ft). No townhome, product-mix, or multi-product representation exists anywhere in the harness/pipeline.
- Scoring 59 detached + 32 townhomes through the single-product harness would compare a single-product scheme count against a mixed-product approved count — structurally invalid. Per the mission rule, the plat was NOT forced through.
- This is a first-class finding, not just a miss: it confirms the benchmark cannot currently measure the product-mix problem the accuracy directive (2026-09-24) targets, and it gives Rank-1's product-mix-prior design a concrete blocked test case (V11B Plat 2 becomes scoreable once mix support exists AND the packet's design guidelines are sourced).

**Pivot survey (bounded): fresh single-family doc_ready candidate.**
- Daybreak Village 12B Plat 4 (PLPP202500250, Gray Ghost Drive/7190 W between 11260 S and 11390 S, LHM Real Estate): vote CONFIRMED 3-0 on 2026-03-10 (Gedge motion, Hollist second; Harding/Catmull absent) via two independent minutes copies (mccmeetings blob packet; binghamcreekregionalpark.org true-and-correct copy, minutes approved 2026-04-14). BUT the staff report was NOT reached after bounded attempts (mccmeetings blob, sjc.utah.gov DocumentCenter React SPA, PMN search 404, web search). Chair's transcript remark of "50 homes" is NOT an official figure. Status: vote_confirmed_document_incomplete — a lead for the next lane (retry V12B P4 PACKET.pdf via the municode 03/10/2026 meeting page, or GRAMA).
- GR-10 pool recheck: V12B Plat 1 done (GR-11); V12B Plat 3 not scoreable (GR-12, do-not-retry); V12B Plat 2 = church use; South Station Plat 5 = commercial; V7A amend = trivial; Homestead at Butterfield + Mardam Ranch = document-blocked (404s/GRAMA). No fresh doc_ready single-family candidate secured this wave.
