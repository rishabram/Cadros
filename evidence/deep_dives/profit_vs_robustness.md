# Evidence report — parcel `08251510020000`
...
- This parcel (`08251510020000`) covers **95.03 acres** in the **M-2** district. Zoning district assignment comes from the real parcel/zoning spatial join; dimensional minimums used for screening are **PROVISIONAL** unless the rule is human-verified (see Section 3).
- The pipeline drew **8 subdivision scheme(s)** (8 geometry-clean, 0 flagged). The top-ranked scheme, `scheme_00`, lays out **37 lots** with 2,160.9 ft of new road and projects **$3,582,080 profit** at **71.7% margin**.
- RuleGraph check: **8 scheme(s) PASS, 0 FAIL, 0 UNKNOWN** across the 8 rule(s) in the verified store.
  - **None of the store's rules apply to the M-2 district** (the 8 verified rules cover MU-11 and PL only), so every PASS above means 'nothing in the store to check against' — not 'compliant'. No in-district dimensional rule has been human-verified yet.
...
- Bottom line: the profit numbers are a geometry-and-assumption sketch. Compliance against M-2 rules has not been checked at all — no in-district rules exist in the verified store yet.
...
| Fact | Value |
| --- | --- |
| parcel_id | `08251510020000` |
| status | `ok` |
| area | 4,139,383 sqft (95.03 acres) |
| CRS | `local-feet` |
| zoning district | `Heavy Manufacturing (real AGRC/SLC parcel; dimensionals PROVISIONAL except as verified)` |
...
| geometry notes | 8 scheme(s): 8 geometry-clean, 0 flagged; new road 1,548–2,160.9 ft across schemes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `scheme_00` | 37 | 2,161 | $4,995,000 | $1,412,920 | $3,582,080 | 71.7% | clean |
| 2 | `scheme_01` | 34 | 1,874 | $4,590,000 | $1,247,524 | $3,342,476 | 72.8% | clean |
| 3 | `scheme_03` | 30 | 1,595 | $4,050,000 | $1,085,882 | $2,964,118 | 73.2% | clean |
| 4 | `scheme_04` | 30 | 1,626 | $4,050,000 | $1,104,246 | $2,945,754 | 72.7% | clean |
| 5 | `scheme_05` | 29 | 1,692 | $3,915,000 | $1,142,014 | $2,772,986 | 70.8% | clean |
| 6 | `scheme_02` | 31 | 2,161 | $4,185,000 | $1,412,920 | $2,772,080 | 66.2% | clean |
| 7 | `scheme_06` | 29 | 1,874 | $3,915,000 | $1,247,524 | $2,667,476 | 68.1% | clean |
| 8 | `scheme_07` | 26 | 1,548 | $3,510,000 | $1,058,970 | $2,451,030 | 69.8% | clean |
...
- Reason: not applicable: rule district PL != parcel district M-2
...
- Verdict: **PASS**
- Applicable to this scheme: `False`
- Reason: not applicable: rule district MU-11 != parcel district M-2
...
Top scheme: `scheme_00` (37 lots).

| Line | Amount |
| --- | --- |
| Revenue | $4,995,000 |
| — infrastructure cost | $1,134,472 |
| — soft costs | $150,000 |
| — contingency | $128,447 |
| **Total cost** | **$1,412,920** |
| **Profit** | **$3,582,080** |
| **Margin** | **71.7%** |
